...
Front-end e product engineer: construo interfaces rápidas, acessíveis e com cara de produto — não só de protótipo.

- 💼 Aplicações web de alta performance, unindo engenharia e visão de produto
- 🛠️ Stack principal: **React, Next.js, TypeScript, Tailwind CSS** e arquiteturas modernas
- ☕ Café, cubos mágicos e obsessão saudável por UI/UX e código limpo
- 📍 São Paulo, Brasil
...
<div align="center">
  ...
  <p>Aberto a produtos, front-end e ideias que merecem virar experiência de verdade.</p>
  <a href="mailto:phregenes@gmail.com">
